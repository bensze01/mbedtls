...
This change affects users who modified the default `mbedtls_config_defines.h` padding granularity
settings, i.e. enabled at least one of the options.

The `mbedtls_config_defines.h` options `MBEDTLS_SSL_CID_PADDING_GRANULARITY` and
