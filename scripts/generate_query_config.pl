...
# include/mbedtls/mbedtls_config_defines.h. The idea is that the mbedtls_config_defines.h contains ALL the
# compile time configurations available in Mbed TLS (commented or uncommented).
# This script extracts the configuration macros from the mbedtls_config_defines.h and this
...
my $config_file = "./include/mbedtls/mbedtls_config_defines.h";
