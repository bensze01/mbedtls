...
class Setting:
    """Representation of one Mbed TLS mbedtls_config_defines.h setting.
    ...
    * active: True if name is defined, False if a #define for name is
      present in mbedtls_config_defines.h but commented out.
...
class ConfigFile(Config):
    ...
    _path_in_tree = 'include/mbedtls/mbedtls_config_defines.h'
    ...
    def _parse_line(self, line):
        """Parse a line in mbedtls_config_defines.h and return the corresponding template."""
        line = line.rstrip('\r\n')
    ...
    def _format_template(self, name, indent, middle):
        """Build a line for mbedtls_config_defines.h for the given setting.
...
if __name__ == '__main__':
    def main():
        """Command line mbedtls_config_defines.h manipulation tool."""
