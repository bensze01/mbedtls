...
cp include/mbedtls/mbedtls_config_defines.h include/mbedtls/mbedtls_config_defines.h.bak
...
mv include/mbedtls/mbedtls_config_defines.h.bak include/mbedtls/mbedtls_config_defines.h
if [ -n "$make_ret" ]; then
    exit "$make_ret"
fi
