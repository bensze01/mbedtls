 ...
 * kept at its default value (and not overridden in mbedtls_config_defines.h) and that the
 ...
 * Either change them in mbedtls_config_defines.h or define them using the compiler command
 * line.
 * \{
 */
