 ...
 * Either change them in mbedtls_config_defines.h or define them on the compiler command line.
 * \{
 */
 ...
 *                 the mbedtls_config_defines.h setting \c MBEDTLS_SSL_OUT_CONTENT_LEN, extensions
 ...
 * \note           The logic to determine the maximum outgoing record payload is
 *                 version-specific. It takes into account various factors, such as
 *                 the mbedtls_config_defines.h setting \c MBEDTLS_SSL_IN_CONTENT_LEN, extensions
