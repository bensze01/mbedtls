...
/*
 * It is recommended to include this file from your mbedtls_config_defines.h
...
/* Fix the config here. Not convenient to put an #ifdef _WIN32 in mbedtls_config_defines.h as
